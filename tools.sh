...
echo "-------------------------------------------------------" | lolcat
echo   "Author   : Rana Nadeem $white" |lolcat
echo   "Contact  : 03082503426 $white" |lolcat
echo   "YouTube  : Trick Master $white" |lolcat
echo   "Facebook    : Rana Nadeem Rajput $white" |lolcat
echo "-------------------------------------------------------" | lolcat
echo "                           v2.0              " | lolcat
###################################################
# CTRL + C
...
case $pil in
01) clear
toilet -f standard " RANA " -F gay
git clone https://github.com/rixon-cochi/Tool-X
cd Tool-X
sh install.aex
...
00) echo "created by : RANA-NADEEM" | lolcat
exit
;;
